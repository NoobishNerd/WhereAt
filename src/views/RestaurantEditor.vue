<template>
  <div class="container">
      ...
      >
        ...
        >
          ...
          <div class="carousel-inner">
            ...
            >
              <button
                @click="removePhoto(photo.id_photo)"
                id="removePhotoBtn"
                class="px-5 mb-2 mt-2"
              >
                Remover foto
              </button>
              <img
    ...
    <div id="finalCrate" class="row d-flex">
      ...
      <div
        @click="call('comments', 'comentary')"
        id="comentary"
        class="col-sm-2 pt-3 ml-3 mt-3 "
      ...
      <div
        @click="call('info', 'information')"
        id="information"
        class="col-sm-2 mt-3 pt-1 "
...
export default {
  ...
  methods: {
    ...
    async addPhoto() {
      ...
      if (url) {
        await restaurantService.addPhoto(
          { srcLink: url },
          this.$route.params.id
        );
      }
